...
for i = 1:length(alphabet)
    ...
    day1(i) = nanmean(d.confusability(intersect(idx_symbol, day1idx)));
    day1std(i) = nanstd(d.confusability(intersect(idx_symbol, day1idx)));
    day2(i) = nanmean(d.confusability(intersect(idx_symbol, day2idx)));
    day2std(i) = nanstd(d.confusability(intersect(idx_symbol, day2idx)));
    day3(i) = nanmean(d.confusability(intersect(idx_symbol, day3idx)));
    day3std(i) = nanstd(d.confusability(intersect(idx_symbol, day3idx)));
    day4(i) = nanmean(d.confusability(intersect(idx_symbol, day4idx)));
    day4std(i) = nanstd(d.confusability(intersect(idx_symbol, day4idx)));
    day5(i) = nanmean(d.confusability(intersect(idx_symbol, day5idx)));
    day5std(i) = nanstd(d.confusability(intersect(idx_symbol, day5idx)));
    day6(i) = nanmean(d.confusability(intersect(idx_symbol, day6idx)));
    day6std(i) = nanstd(d.confusability(intersect(idx_symbol, day6idx)));

    day1y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day1idx))); 
    day1ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day1idx))); 
    day2y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day2idx)));
    day2ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day2idx)));
    day3y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day3idx)));
    day3ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day3idx)));
    day4y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day4idx)));
    day4ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day4idx)));
    day5y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day5idx)));
    day5ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day5idx)));
    day6y(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, yidx), day6idx)));
    day6ystd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, yidx), day6idx)));

    day1o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day1idx))); 
    day1ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day1idx)));
    day2o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day2idx)));
    day2ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day2idx)));
    day3o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day3idx)));
    day3ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day3idx)));
    day4o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day4idx)));
    day4ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day4idx)));
    day5o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day5idx)));
    day5ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day5idx)));
    day6o(i) = nanmean(d.confusability(intersect(intersect(idx_symbol, oidx), day6idx)));
    day6ostd(i) = nanstd(d.confusability(intersect(intersect(idx_symbol, oidx), day6idx)));
...
yax.TickValues = [0 0.08 0.16 0.24];
yax.TickDirection = 'out';
% yax.TickLength = [yticklength yticklength];
yax.TickLabels = {'0', '0.08', '0.16', '0.24'};
yax.FontName = fontname;
yax.FontSize = fontsize;
yax.Label.FontAngle= 'italic';
% yax.TickLabelRotation = 0;
yax.Label.String = 'Confusability Score';
...
print(fullfile(rootdir, 'plots', ['plot_bar_6days_confusability_n=' num2str(nall)]), '-dpng')
...
out.Properties.VariableNames = {'letter', 'day1', 'day1std', 'day2', 'day2std', 'day3', 'day3std', 'day4', 'day4std', 'day5', 'day5std', 'day6', 'day6std', ...
    ...
    'day1o', 'day1ostd', 'day2o', 'day2ostd', 'day3o', 'day3ostd', 'day4o', 'day4ostd', 'day5o', 'day5ostd', 'day6o', 'day6ostd'};
writetable(out, fullfile(rootdir, 'supportfiles', 'table3_6days_confusability.csv'))
